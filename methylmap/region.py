...
class Region(object):
    def __init__(self, region=None, expand=False, tup=None, extra=0):
        if tup:
        ...
        ## WDC: from my understanding, expand is a command line argument and extra is some buffer we want to load to make the app faster?
        if extra:
            self.begin = self.begin - extra
            self.end = self.end + extra
