...
rule heatmap:
    ...
    shell:
         "python heatmap_test.py --files {input.files} --window chr17:44345246-44353106 --expand 100000 --gff {input.gff} --outtable {output.outtable} --outfig {output.outfig} 2> {log}"
