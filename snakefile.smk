...
sample_info_baminput = pd.read_table("/home/ecoopman/methylmap/baminput/bamfiles/bamfiles.txt").set_index("SAMPLE", drop=False)
sample_info_baminput = sample_info_baminput.rename(columns=sample_info_baminput.iloc[0])
sample_info_baminput.BAM = "/home/ecoopman/methylmap/baminput/bamfiles + sample_info_baminput.BAM"
...
rule methylmap:
    input:
        #inp = os.path.join("/home/ecoopman/methylmap/methfreqtable/methfreqtable_chr_limited.tsv.gz"),
        ...
        bam = expand(os.path.join("/home/ecoopman/methylmap/baminput/bamfiles/{id}.bam"), id=sample_info_baminput),
        fasta = os.path.join("/home/ecoopman/methylmap/baminput/hg38.fa.gz"),
    ...
    shell:
         "python methylmap.py --files {input.bam} --window chr17:44345246-44353106 --fasta {input.fasta} --outfig {output.outfig} --outtable {output.outtable} 2> {log}"
